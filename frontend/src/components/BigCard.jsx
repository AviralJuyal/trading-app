...
const BigCard = ({
  ...
  // console.log(tokens);
  return (
    <div className="absolute top-10 shadow-xl w-[45%] flex flex-col items-center justify-center bg-white rounded-xl px-6 pb-8">
      <div className="relative top-52 flex items-center justify-center bg-white shadow-xl rounded-full h-10 w-10">
        <FiArrowDown className="text-2xl text-blue-500 font-bold" />
      </div>
      ...
      <div className="flex items-end w-full justify-between bg-[#f4f6fc] rounded-xl my-1 p-4">
        <div className="w-[60%] flex flex-col items-start justify-start gap-y-2 ">
          <p className="text-lg text-gray-500">You sell</p>

          <Select
            value={options.find(
              (option) => option.value === selectedToken.src || options[0]
            )} // Add this line
      ...
      <div className="flex items-end w-full justify-between border bg-white border-[#f4f6fc] rounded-xl my-1 p-4">
        <div className="w-[60%] flex flex-col items-start justify-start gap-y-2 ">
          <p className="text-lg text-gray-500">You buy</p>

          <Select
            value={options.find(
              (option) => option.value === selectedToken.dst || options[0]
            )} // Add this line
            closeMenuOnSelect={true}
            className="w-full rounded-lg text-lg flex items-start justify-start align-start cursor-pointer"
            options={options}
      ...
      <div className="flex items-end w-full justify-between bg-[#f4f6fc] rounded-xl my-1 p-3">
        <div className="flex items-center justify-start gap-y-2 ">
        ...
        <div className="flex items-end justify-end gap-y-2">
          <p className="text-lg text-gray-500">~$0.01</p>
        </div>
      </div>

      <div
        className={`flex items-center w-full justify-center border ${
        ...
        {account ? (
          ...
          <>
            <BiWallet
              ...
              className="text-3xl text-blue-500 font-bold mx-2"
            />
            <p className="text-2xl text-blue-500 font-bold">Connect Wallet</p>
          </>
        )}
      </div>
    </div>
